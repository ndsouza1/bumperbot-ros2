#ifndef BUMPERBOT_LOCALIZATION_KALMAN_FILTER_HPP
#define BUMPERBOT_LOCALIZATION_KALMAN_FILTER_HPP
...
private:
    ...
    double motion_variance_; //robot motion
    double measurement_variance_; //inertial sensor
