...
def generate_launch_description():
    ...
    joint_state_broadcaster_spawner = TimerAction(
        period=5.0,  # Wait for Gazebo's controller manager to be ready
        actions=[
            Node(
        ...
        actions=[
            Node(
                ...
                arguments=[
                    ...
                    '--controller-manager', '/controller_manager',
                    '--controller-manager-timeout', '20',
                    '--ros-args', '--params-file', LaunchConfiguration('controller_config_file')
                ],
    ...
    simple_controller= GroupAction(
        ...
        actions=[
                TimerAction(
                    period=8.0,  # Wait longer for joint state broadcaster to be ready
                    actions=[
                        Node(
                            package='controller_manager',
                            executable='spawner',
